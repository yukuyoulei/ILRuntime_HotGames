...
public abstract class AHotBase
{
	...
	{
		return UHotStaticFuncs.FindChildComponent<T>(gameObj.transform, widgetName);
	}
	public static T FindWidget<T>(Transform trans, string widgetName) where T : Component
	{
		return UHotStaticFuncs.FindChildComponent<T>(trans, widgetName);
	}
	...
	{
		var w = UHotStaticFuncs.FindChildComponent<Component>(parent, widgetName);
		if (w != null)
		{
