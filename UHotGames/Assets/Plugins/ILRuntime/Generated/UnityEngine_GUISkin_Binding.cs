...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_GUISkin_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_button_0);
            args = new Type[]{typeof(UnityEngine.GUIStyle)};
            method = type.GetMethod("set_box", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_box_1);
            args = new Type[]{typeof(UnityEngine.GUIStyle[])};
            method = type.GetMethod("set_customStyles", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_customStyles_2);
        ...
        static StackObject* set_button_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_box_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
