...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_ExecuteEvents_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_submitHandler_0);
            ...
            args = new Type[]{typeof(UnityEngine.EventSystems.ISubmitHandler)};
            if (genericMethods.TryGetValue("Execute", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Boolean), typeof(UnityEngine.GameObject), typeof(UnityEngine.EventSystems.BaseEventData), typeof(UnityEngine.EventSystems.ExecuteEvents.EventFunction<UnityEngine.EventSystems.ISubmitHandler>)))
                    {
        ...
        static StackObject* get_submitHandler_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
