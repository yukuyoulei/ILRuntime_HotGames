...
{
    unsafe class WebSocketSharp_CloseEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(WebSocketSharp.CloseEventArgs);
            args = new Type[]{};
            method = type.GetMethod("get_Reason", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Reason_0);
