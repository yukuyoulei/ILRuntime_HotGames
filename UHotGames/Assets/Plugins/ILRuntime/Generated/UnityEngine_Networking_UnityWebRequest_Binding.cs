...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Networking_UnityWebRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, EscapeURL_0);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("UnEscapeURL", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, UnEscapeURL_1);


        }


        static StackObject* EscapeURL_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* UnEscapeURL_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
