...
namespace ILRuntime.Runtime.Generated
{
    unsafe class WebSocketSharp_MessageEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_IsText", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsText_1);
            args = new Type[]{};
            method = type.GetMethod("get_RawData", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_RawData_2);
        ...
        static StackObject* get_RawData_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
