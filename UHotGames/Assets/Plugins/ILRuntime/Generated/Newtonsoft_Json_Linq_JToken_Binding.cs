...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Newtonsoft_Json_Linq_JToken_Binding
    {
        ...
        static StackObject* get_Type_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Newtonsoft.Json.Linq.JToken instance_of_this_method = (Newtonsoft.Json.Linq.JToken)typeof(Newtonsoft.Json.Linq.JToken).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
