...
{
    unsafe class WebSocketSharp_ErrorEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(WebSocketSharp.ErrorEventArgs);
            args = new Type[]{};
        ...
        static StackObject* get_Message_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            WebSocketSharp.ErrorEventArgs instance_of_this_method = (WebSocketSharp.ErrorEventArgs)typeof(WebSocketSharp.ErrorEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
