...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Net_Sockets_Socket_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_RemoteEndPoint_0);


        }


        static StackObject* get_RemoteEndPoint_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
